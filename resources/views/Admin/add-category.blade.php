...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{route('admin.post.add.category')}}" method="post" enctype="multipart/form-data">
@csrf
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="inputEmail4">Categort Name :</label>
                    <input type="text" name="category_name" class="form-control" id="inputEmail4" placeholder="Category name">
                </div>
                <div class="col-md-12">
                ...
                <div class="form-group col-md-12">
                    ...
                    <br>
                    <input type="file" class="" name="category_image" id="customFile" placeholder="Password">
                </div>
                <div class="form-group col-md-12">
                    <button type="submit" class="btn btn-primary" id="">Add Category +</button>
                </div>
            </div>
        </form>
    </div>
