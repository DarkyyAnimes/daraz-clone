...
@section('content')
            <div class="">                                            
                <div class="topperformingproduct my-5">                    
                    <h1 class="text-4xl font-bold ">Complete Orders Products</h1>
                    @if(session('message'))
                                    ...
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="px-6 items-center flex py-4">
                                            @if ($product['received'] == "true")                                            
                                                <div class="edit bg-green-200 px-10 py-2 text-gray-500 mr-4 rounded">Done</div>
                                            @else
                                                <div class="edit bg-red-600 px-10 py-2 text-white mr-4 rounded">Not yet</div>
                                            @endif
                                        </td>
                                    </tr>                                
                                @endforeach
