...
<ul>
    <li class="py-2 px-10 bg-orange-500 rounded text-xl shadow m-2"><a href="">Dashboard</a></li>
    <div class="relative w-full">
        ...
        <ul class="absolute hidden bg-white dropdown-menu shadow-md rounded mt-2 right-0 w-36">
            ...
            <li class="hover:bg-gray-100">
                <a href="#" class="block text-black py-2 px-4">See All</a>
            </li>
            <li class="hover:bg-gray-100">
                <a href="#" class="block text-black py-2 px-4">Add +</a>
            </li>
        </ul>
    </div>

    <li class="py-2 px-10 bg-orange-500 rounded text-xl shadow m-2">Profile</li>
    <div class="relative w-full">
        <!-- Dropdown Trigger -->
        <button type="button"
            class="py-2 w-[95%] text-left  dropdown-btn px-10 bg-orange-500 rounded text-xl shadow m-2">
